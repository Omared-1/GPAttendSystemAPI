...
namespace GPAttendSystemAPI.Controllers
{
    ...
    public class H406TodaysAttendController : ControllerBase
    {
        ...
        //[Authorize(Roles = "DataMining, ExpertSystem")]
        //[HttpGet("DownloadStudentsExcelToday")]
        ...
        //            return File(stream.ToArray(), "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", $"AttendanceMonthly{role}.xlsx");
        //        }
        //    }
        //}
